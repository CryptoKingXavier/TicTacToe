...
document.addEventListener("DOMContentLoaded", () => {
    const section_state = ["X", "O"];
    const generateRandomIdx = (min, max) => {
        min = Math.ceil(min);
        max = Math.floor(max);
        return Math.floor(Math.random() * (max - min + 1)) + min;
    };
    const check_wins = (section) => {
        if (section[0].innerHTML === section[1].innerHTML &&
    ...
    const r1_c1 = document.getElementById("r1-c1");
    const r1_c2 = document.getElementById("r1-c2");
    const r1_c3 = document.getElementById("r1-c3");
    const r2_c1 = document.getElementById("r2-c1");
    const r2_c2 = document.getElementById("r2-c2");
    const r2_c3 = document.getElementById("r2-c3");
    const r3_c1 = document.getElementById("r3-c1");
    const r3_c2 = document.getElementById("r3-c2");
    const r3_c3 = document.getElementById("r3-c3");
    // States Registry
    const State = {
    ...
    const auto_check_wins = () => setInterval(() => {
    ...
    positions.map((position) => {
        position.onclick = () => {
            ...
            let computer_choice = available_slots[generateRandomIdx(0, available_slots.length)];
            do {
